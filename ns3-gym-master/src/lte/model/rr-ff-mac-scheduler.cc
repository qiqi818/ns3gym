...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "RrFfMacScheduler" << std::endl;
  if(m_flag == 1)
  {
...
{
  //std::cout << "执行了"<< Simulator::Now() << "GetTypeId" << std::endl;
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "SetFfMacCschedSapUser" << std::endl;
  m_cschedSapUser = s;
}
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "SetFfMacSchedSapUser" << std::endl;
  m_schedSapUser = s;
}
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "GetFfMacCschedSapProvider" << std::endl;
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "GetFfMacSchedSapProvider" << std::endl;
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "SetLteFfrSapProvider" << std::endl;
  m_ffrSapProvider = s;
}
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "GetLteFfrSapUser" << std::endl;
  return m_ffrSapUser;
}
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoCschedCellConfigReq" << std::endl;
  NS_LOG_FUNCTION (this);
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoCschedUeConfigReq" << std::endl;
  // //std::cout << this <<  "执行了"<< Simulator::Now() << "DoCschedUeConfigReq" << std::endl;
  //std::cout << this << " RNTI " << params.m_rnti << std::endl;
  if(m_flag == 0)
  {
    // //std::cout << "执行0-----" << std::endl;
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoCschedLcConfigReq" << std::endl;
  // if(m_flag == 0)
  // {
  //   //std::cout << "执行0" << std::endl;
  // NS_LOG_FUNCTION (this);
  ...
  // {
    // //std::cout << "执行1" << std::endl;
    NS_LOG_FUNCTION (this << Simulator::Now() << " New LC, rnti: "  << params.m_rnti);
    //std::cout << this << " New LC, rnti: "  << params.m_rnti << std::endl;
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoCschedLcReleaseReq" << std::endl;
  // if(m_flag == 0)
  // {
  //   //std::cout << "执行0" << std::endl;
  // NS_LOG_FUNCTION (this);
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoSchedDlRlcBufferReq" << std::endl;
  
    // //std::cout << "执行0" << std::endl;
  //std::cout << params.m_rnti << std::endl;
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoSchedDlPagingBufferReq" << std::endl;
  NS_LOG_FUNCTION (this);
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoSchedDlMacBufferReq" << std::endl;
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
}
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "GetRbgSize" << std::endl;
  for (int i = 0; i < 4; i++)
    {
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "LcActivePerFlow" << std::endl;
  std::map <LteFlowId_t, FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
...
{
  //std::cout <<  "执行了"<< Simulator::Now() << "SortRlcBufferReq" << std::endl;
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "HarqProcessAvailability" << std::endl;
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "UpdateHarqProcessId" << std::endl;
  if(m_flag == 0)
  {
  NS_LOG_FUNCTION (this << rnti);
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "RefreshHarqProcesses" << std::endl;
  NS_LOG_FUNCTION (this);
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoSchedDlTriggerReq" << std::endl;
  if(m_flag == 4)//pf
  {
  ...
  for (itRach = m_rachList.begin (); itRach != m_rachList.end (); itRach++)
    {
      ...
      ////std::cout<< this << " UL grant allocated to RNTI " << (*itRach).m_rnti << " rbStart " << rbStart << " rbLen " << rbLen << " MCS " << m_ulGrantMcs << " tbSize " << newRar.m_grant.m_tbSize;
  ...
  for (int i = 0; i < rbgNum; i++)
    {
      ...
      if (rbgMap.at (i) == false)
        {
          std::map <uint16_t, RrsFlowPerf_t>::iterator it;
          std::map <uint16_t, RrsFlowPerf_t>::iterator itMax = m_flowStatsDl.end ();
          double rcqiMax = 0.0;
          // //std::cout  << "-------------------------------------------" << std::endl;
      ...
      for (uint16_t k = 0; k < (*itMap).second.size (); k++)
        {
          ...
          ////std::cout<< this << " Allocated RBG " << (*itMap).second.at (k) << std::endl;
        }
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoSchedDlRachInfoReq" << std::endl;
  NS_LOG_FUNCTION (this);
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoSchedDlCqiInfoReq" << std::endl;
  // if(m_flag == 0)
  // {
  //   //std::cout << "执行0" << std::endl;
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "EstimateUlSinr" << std::endl;
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoSchedUlTriggerReq" << std::endl;
  if(m_flag == 4)
  {
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoSchedUlNoiseInterferenceReq" << std::endl;
  NS_LOG_FUNCTION (this);
  return;
}
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoSchedUlSrInfoReq" << std::endl;
  NS_LOG_FUNCTION (this);
  return;
}
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoSchedUlMacCtrlInfoReq" << std::endl;
  if(m_flag == 0)
  {
    // //std::cout << "执行0" << std::endl;
  NS_LOG_FUNCTION (this);
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "DoSchedUlCqiInfoReq" << std::endl;
  // if(m_flag == 0)
  // {
  //   //std::cout << "执行0" << std::endl;
  // NS_LOG_FUNCTION (this);
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "RefreshDlCqiMaps" << std::endl;
  // if(m_flag == 0)
  // {
  //   //std::cout << "执行0" << std::endl;
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "RefreshUlCqiMaps" << std::endl;
  // refresh UL CQI  Map
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "UpdateDlRlcBufferInfo" << std::endl;
  ...
  if (it != m_rlcBufferReq_1.end ())
    ...
    // //std::cout << "执行0" << std::endl;
  NS_LOG_FUNCTION (this);
  std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it1;
  for (it1 = m_rlcBufferReq.begin (); it1 != m_rlcBufferReq.end (); it1++)
    {
      if (((*it1).m_rnti == rnti) && ((*it1).m_logicalChannelIdentity == lcid))
        {
          NS_LOG_INFO (this << " UE " << rnti << " LC " << (uint16_t)lcid << " txqueue " << (*it1).m_rlcTransmissionQueueSize << " retxqueue " << (*it1).m_rlcRetransmissionQueueSize << " status " << (*it1).m_rlcStatusPduSize << " decrease " << size);
          // Update queues: RLC tx order Status, ReTx, Tx
          // Update status queue
           if (((*it1).m_rlcStatusPduSize > 0) && (size >= (*it1).m_rlcStatusPduSize))
              {
                (*it1).m_rlcStatusPduSize = 0;
              }
            else if (((*it1).m_rlcRetransmissionQueueSize > 0) && (size >= (*it1).m_rlcRetransmissionQueueSize))
              {
                (*it1).m_rlcRetransmissionQueueSize = 0;
              }
            else if ((*it1).m_rlcTransmissionQueueSize > 0)
              {
                uint32_t rlcOverhead;
                if (lcid == 1)
                  {
                    // for SRB1 (using RLC AM) it1's better to
                    // overestimate RLC overhead rather than
                    // underestimate it1 and risk unneeded
                    // segmentation which increases delay 
                    rlcOverhead = 4;                                  
                  }
                else
                ...
                // update transmission queue
                if ((*it1).m_rlcTransmissionQueueSize <= size - rlcOverhead)
                  {
                    (*it1).m_rlcTransmissionQueueSize = 0;
                  }
                else
                  {                    
                    (*it1).m_rlcTransmissionQueueSize -= size - rlcOverhead;
                  }
              }
          // return;
        }
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "UpdateUlRlcBufferInfo" << std::endl;
...
{
  //std::cout << this <<  "执行了"<< Simulator::Now() << "TransmissionModeConfigurationUpdate" << std::endl;
