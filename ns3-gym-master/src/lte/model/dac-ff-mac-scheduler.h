...
#ifndef DAC_FF_MAC_SCHEDULER_H
#define DAC_FF_MAC_SCHEDULER_H
...
class DacFfMacScheduler : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
  ...
  /// allow MemberCschedSapProvider<DacFfMacScheduler> class friend access
  friend class MemberCschedSapProvider<DacFfMacScheduler>;
  /// allow MemberSchedSapProvider<DacFfMacScheduler> class friend access  
  friend class MemberSchedSapProvider<DacFfMacScheduler>;
