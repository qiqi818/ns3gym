...
#ifndef ASYNC_FF_MAC_SCHEDULER_H
#define ASYNC_FF_MAC_SCHEDULER_H
...
class AsyncFfMacScheduler : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
  ...
  /// allow MemberCschedSapProvider<AsyncFfMacScheduler> class friend access
  friend class MemberCschedSapProvider<AsyncFfMacScheduler>;
  /// allow MemberSchedSapProvider<AsyncFfMacScheduler> class friend access  
  friend class MemberSchedSapProvider<AsyncFfMacScheduler>;
